...
|---|---|
| Normal mode  | ~52.72 |
| Standby Mode: USB disable, GNSS disable, Cellular network **ON**, NAD is **ON** (CS/PS), SoC is LPM mode  | ~8.48 |
| Suspend mode: USB disable, GNSS disable, Cellular network **OFF**, NAD is **LPM** (no CS/PS), SoC is LPM mode  | ~5.48 |
| Shutdown Mode: USB disable, GNSS disable, Cellular network **OFF**, both NAD and Soc in **shutdown** mode  | ~1.42 |
